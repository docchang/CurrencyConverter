/*
	SDZCurrencyConvertor.h
	The interface definition of classes and methods for the CurrencyConvertor web service.
...
@interface SDZCurrencyConvertor : SoapService
	...
	- (SoapRequest*) ConversionRate: (id) target action: (SEL) action FromCurrency: (NSString*) FromCurrency ToCurrency: (NSString*) ToCurrency;
