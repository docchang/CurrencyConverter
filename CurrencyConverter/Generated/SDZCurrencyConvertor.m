/*
	SDZCurrencyConvertor.m
	The implementation classes and methods for the CurrencyConvertor web service.
...
@implementation SDZCurrencyConvertor

	- (id) init
	{
		if(self = [super init])
		{
			self.serviceUrl = @"http://www.webservicex.net/CurrencyConvertor.asmx";
			self.namespace = @"http://www.webserviceX.NET/";
			self.headers = nil;
			self.logging = NO;
		}
		return self;
